...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actScanCodes = QtWidgets.QAction(MainWindow)
        self.actScanCodes.setObjectName("actScanCodes")
        self.actSyncCodes = QtWidgets.QAction(MainWindow)
        self.actSyncCodes.setObjectName("actSyncCodes")
        self.actScannerOnline = QtWidgets.QAction(MainWindow)
        self.actScannerOnline.setObjectName("actScannerOnline")
        self.menu_2.addAction(self.action_3)
        self.menu_2.addAction(self.action_4)
        self.menu_3.addAction(self.actCreateDatabase)
        self.menu_3.addAction(self.actChangeDatabase)
        self.menu_3.addAction(self.actSyncDatabase)
        ...
        self.menu_5.addAction(self.actScanCodes)
        self.menu_5.addAction(self.actSyncCodes)
        self.menu_6.addAction(self.actScannerOnline)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_4.setTitle(_translate("MainWindow", "Отгрузки"))
        self.menu_5.setTitle(_translate("MainWindow", "Коды маркировки"))
        self.menu_6.setTitle(_translate("MainWindow", "Сканер"))
        ...
        self.actScanCodes.setText(_translate("MainWindow", "Сканировать коды маркировки..."))
        self.actSyncCodes.setText(_translate("MainWindow", "Синхронизировать коды маркировки"))
        self.actScannerOnline.setText(_translate("MainWindow", "Онлайн режим"))
